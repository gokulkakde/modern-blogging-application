...
if (isset($_GET['search'])) {
    ...
    $query = "SELECT * FROM posts WHERE title LIKE '%$search_escaped%' OR body LIKE '%$search_escaped%' ORDER BY date_time DESC";
...
<section class="posts section__extra-margin">
    <div class="container posts__container">
        ...
        <article class="post">
            ...
            $category_title = $category ? $category['title'] : 'General';
            ?>
...
<?php else : ?>
    <div class="alert__message error lg section__extra-margin">
        <p>No posts found matching "<?= htmlspecialchars($search) ?>"</p>
    </div>
<?php endif ?>
<!-- ==============================================END OF POSTS====================================== -->
